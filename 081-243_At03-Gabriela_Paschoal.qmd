...
rm(list=ls())
data<-read.table("C:\\Users\\gabriela.silva\\Desktop\\faculdade\\cq\\Dados\\Tab3.20.txt", dec=",",header=TRUE)
...
A probabilidade do gráfico da média sinalizar o desajuste (deslocamento da média para 250.8) é de 0,9%. A probabilidade do gráfico da amplitude sinalizar o desajuste é 0, pois ele não leva em consideração a média da amostra, apenas seus valores máximo e mínimo. 
...
A probabilidade de qualquer um dos dois gráficos sinalizarem o desajuste é 0. 
